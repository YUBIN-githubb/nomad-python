...
print(day_of_week)
print(day_of_week[2])
#list는 여러 종류의 자료형을 합쳐서 만들수도 있음
list = [1,2,3,True,False,"hi"]

#tuple 연습하기
#tuple은 불변성을 가짐 count와 index 메소드만 쓸 수 있음
days = ("Mon","Tue","Wed")
print(days[0])
#마이너스 인덱스를 불러온다면 맨끝에서부터 불러옴 리스트와 튜플 모두에 적용
print(days[-1])
print(days[-3])
...
player.pop('name') #pop은 키를 없앤다는 의미
print(player)
